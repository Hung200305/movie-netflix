...
import com.netflix.netflix.exceptions.EmptyFileException;
import com.netflix.netflix.service.MovieService;
import com.netflix.netflix.utils.AppConstants;
...
public class MovieController {
    ...
    public ResponseEntity<MovieDto> addMovieHandler(@RequestPart MultipartFile file, @RequestPart String movieDto) throws IOException,EmptyFileException {
        ...
        if(file.isEmpty()) {
            throw new EmptyFileException("File is empty! Plesae send another file!");
        }
